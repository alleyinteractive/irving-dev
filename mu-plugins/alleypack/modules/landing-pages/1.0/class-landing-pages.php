...
class Landing_Pages {
	...
	public function setup() {
		...
		$this->post_type = apply_filters( 'alleypack_landing_page_post_type', $this->post_type );
	...
	public function setup_options() {
		...
		// Setup landing page options.
		$this->options = apply_filters( 'alleypack_landing_page_options', $this->options );
	...
	public function register_post_type() {
		...
		$args = [
			'label'        => __( 'Landing Pages', 'alleypack' ),
			'public'       => true,
			'show_in_rest' => true,
			'show_in_menu' => true,
			'has_archive'  => false,
		...
		$args = apply_filters( 'alleypack_landing_page_post_type_args', $args );
	...
	public function landing_page_meta() {
		...
		$children = apply_filters( 'alleypack_landing_page_fm_children', $children );
		...
		// Add meta box.
		$fm->add_meta_box(
			apply_filters( 'alleypack_landing_page_fm_label', __( 'Landing Page Settings', 'alleypack' ) ),
			[ $this->post_type ],
			'normal',
			'high'
		);
