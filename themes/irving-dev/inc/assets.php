...
function ai_get_versioned_asset_path( $asset_path ) {
	...
	$base_path = is_dev() ?
		...
		IRVING_DEV_URL . '/client/build/';

	if ( ! isset( $asset_map ) ) {
		$asset_map_file = IRVING_DEV_PATH . '/client/build/assetMap.json';
...
function enqueue_assets() {
	wp_enqueue_style( 'irving-dev-global-css', ai_get_versioned_asset_path( 'global.css' ), [], '1.0' );
	wp_enqueue_script( 'irving-dev-global-js', ai_get_versioned_asset_path( 'global.js' ), [], '1.0', true );
}
...
function enqueue_admin() {
	wp_enqueue_script( 'irving-dev-admin-js', ai_get_versioned_asset_path( 'admin.js' ), [], '1.0', true );
	wp_enqueue_style( 'irving-dev-admin-css', ai_get_versioned_asset_path( 'admin.css' ), [], '1.0' );
}
